...
class Myorder extends MY_Controller 
{
    ...
    {
        $this->check_and_delete_expired_orders();
    ...
    private function check_and_delete_expired_orders()
    {
        $orders = $this->myorder->where('status', 'waiting')->get();
        
       
        
    }
    public function delete_expired_order()
    {
        $order_id = $this->input->post('order_id');
        $this->myorder->where('id', $order_id)->delete();
    }
