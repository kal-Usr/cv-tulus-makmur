...
class Order extends MY_Controller 
{
	...
	public function laporan()
    {
        ...
        {
            $data['page'] = 'pages/order/laporan';
            $this->load->view('layouts/app', [
                'view' => 'pages/order/laporan',
                'page' => $data['page']
            ]);
        }
        else
        {
			...
			$data['content'] = $this->order->where('date >=', $tanggal_mulai)
	...
	public function print($tanggal_mulai, $tanggal_selesai)
    {
        ...
        $data['content'] = $this->order->get_laporan($tanggal_mulai, $tanggal_selesai);
